...
opti.subject_to(0<PointM(1));
opti.subject_to(0<PointN(1));
opti.subject_to(PointM(2)==2*(PointM(1)-5));
opti.subject_to(PointN(2)==-2*(PointM(1)-5));
...
opti.set_initial(L1,5);
opti.set_initial(L2,5);
opti.set_initial(L3,5);
opti.set_initial(L4,5);
