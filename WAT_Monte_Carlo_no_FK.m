...
Ay=opti.variable(); opti.subject_to(0<Ay); opti.set_initial(Ay,60);
...
opti.set_initial(PointM_A,[256,30]); opti.set_initial(PointN_A,[256,-30]);
...
Dy=opti.variable(); opti.subject_to(0<Dy); opti.set_initial(Dy,345);
...
% init for point M and N
opti.set_initial(PointM_D,[198,170]); opti.set_initial(PointN_D,[198,-170]);
...
By=opti.variable(); opti.subject_to(0<By); opti.set_initial(By,60);
...
opti.set_initial(PointM_B,[255,31]); opti.set_initial(PointN_B,[256,-31]);
...
Cy=opti.variable(); opti.subject_to(0<Cy); opti.set_initial(Cy,345);
...
opti.set_initial(PointM_C,[197,169]); opti.set_initial(PointN_C,[197,-169]);
